            ...
            <div class="row gx-5">
                <div class="col" align="center">
                    <div class="p-3 border bg-light">
                        <img src="/assets/AdminLTE/dist/img/student.jpg" class="rounded mx-auto d-block" height="150px">
                        <a href="/mahasiswa" type="button" class="btn btn-secondary btn-sm">Mahasiswa</a>
                    </div>
                </div>
                <div class="col" align="center">
                    <div class="p-3 border bg-light">
